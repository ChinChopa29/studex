...
@if($user) 
   <div class="bg-slate-800 text-white m-4 p-6 rounded-2xl shadow-lg">  
      <div class="flex items-center gap-4 mb-6">
         <a href="{{ route('mailRecentDeleted') }}" class="p-2 border-2 border-transparent rounded-full hover:border-gray-400 transition">
            <i class="fa fa-arrow-left text-2xl hover:text-gray-400"></i>
         </a>
         <h2 class="text-2xl font-bold text-gray-200">Удаленное сообщение</h2>
      </div>
