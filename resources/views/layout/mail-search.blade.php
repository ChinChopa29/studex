<div>
   <form id="searchForm" action="{{ route('mailSearch') }}" method="get" class="flex items-center pl-1 mt-4 mb-6 gap-2 w-full">
       @csrf
       ...
       <a href="@stack('return-to')" class="bg-red-500 py-2.5 px-4 rounded-lg hover:bg-red-700 transition-all duration-200 w-12">
